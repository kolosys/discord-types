...
type Team struct {
	...
	OwnerUserID discord.Snowflake `json:"owner_user_id"`
...
type TeamMember struct {
	...
	TeamID discord.Snowflake `json:"team_id"`
...
//
// See: https://discord.com/developers/docs/topics/teams#data-models-team-member-role-types
