...
type UserPrimaryGuild struct {
	...
	IdentityGuildID *discord.Snowflake `json:"identity_guild_id"`
...
type PartialGuildIntegration struct {
	// This would contain partial fields from GuildIntegration
	// Implementation depends on the actual guild integration structure
}
